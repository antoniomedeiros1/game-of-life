...
INFINIT = [
    [40, 18], [40, 19], [41, 18], [41, 19], [53, 15], [52, 16], [54, 16], [51, 17], [55, 17], [56, 17], [51, 18], [51, 19], [52, 20], [55, 18], [55, 19], [54, 20], [56, 20], [53, 21], [57, 18], [57, 19], [57, 20], [58, 18], [58, 19], [
...
def main():
    ...
    #                   for j in range(H)])
    cells = np.array(
        [[1 if [i, j] in INFINIT else 0 for i in range(W)]for j in range(H)])
